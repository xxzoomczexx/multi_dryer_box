...
static __pio_const uint16_t spi_gap0_sample1_program_instructions[] = {
            //     .wrap_target
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program spi_gap0_sample1_program = {
...
static __pio_const uint16_t spi_gap01_sample0_program_instructions[] = {
            //     .wrap_target
    0x6001, //  0: out    pins, 1         side 0
    0x1040, //  1: jmp    x--, 0          side 1
    0xe080, //  2: set    pindirs, 0      side 0
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program spi_gap01_sample0_program = {
...
static __pio_const uint16_t spi_gap010_sample1_program_instructions[] = {
            //     .wrap_target
    0x6001, //  0: out    pins, 1         side 0
    0x1040, //  1: jmp    x--, 0          side 1
    0xe080, //  2: set    pindirs, 0      side 0
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program spi_gap010_sample1_program = {
...
static __pio_const uint16_t spi_gap0_sample1_regular_program_instructions[] = {
            //     .wrap_target
    0x6001, //  0: out    pins, 1         side 0
    0x1040, //  1: jmp    x--, 0          side 1
    0xe080, //  2: set    pindirs, 0      side 0
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program spi_gap0_sample1_regular_program = {
